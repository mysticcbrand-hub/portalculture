  ...
  return (
    <section ref={heroRef} className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: `
            radial-gradient(ellipse 100% 80% at 50% 0%, rgba(20, 18, 30, 0.9) 0%, transparent 50%),
            radial-gradient(ellipse 80% 60% at 80% 100%, rgba(15, 12, 25, 0.6) 0%, transparent 40%),
            radial-gradient(ellipse 60% 50% at 20% 80%, rgba(18, 15, 28, 0.5) 0%, transparent 40%)
          `,
        }}
      />
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20">
          ...
          >
            ...
            ">
              <span className="relative flex h-1.5 w-1.5">
                <span className="absolute inline-flex h-full w-full rounded-full bg-emerald-400/60 animate-ping" style={{ animationDuration: '2.5s' }} />
          ...
          <div 
            className={`
              mt-14 md:mt-16
              flex items-center gap-4 text-[11px] md:text-xs
              transition-all duration-1000 ease-out
              ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}
            `}
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-white/50 font-medium">+500 miembros</span>
              <span className="text-white/30">activos ahora</span>
            </div>
          </div>
        </div>
